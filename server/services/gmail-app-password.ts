    ...
    try {
      ...
      const auth = new google.auth.GoogleAuth({
        ...
        credentials: {
          ...
          client_id: process.env.GOOGLE_CLIENT_ID || "378868803078-50gj80qdtcji129idk73mb5kjtski9da.apps.googleusercontent.com",
          client_secret: process.env.GOOGLE_CLIENT_SECRET || "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",
